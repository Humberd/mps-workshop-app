...
/*package*/ class Project_Component_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.quantity$eYK0;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.component$eYKY;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.component$eYKY);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.component$eYKY);
    }
